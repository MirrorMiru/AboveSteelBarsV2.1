...
function setup(){
    ...
    //Dropship
    backgD = createSprite(windowWidth/2-2300 , windowHeight/2+95)
    backgD.addImage(bgImg2)
    backgD.scale = 2
    backgD.visible = false
    //Dropship2
    backgD2 = createSprite(windowWidth/2-5500 , windowHeight/2+95)
    backgD2.addImage(bgImg3)
    backgD2.scale = 2
    backgD2.visible = false
    //Dropship3
    backgD3 = createSprite(windowWidth/2-7500 , windowHeight/2+95)
    backgD3.addImage(bgImg3)
    backgD3.scale = 2
    backgD3.visible = false
    //Dropship3
    backgUG1 = createSprite(windowWidth/2-20000 , windowHeight/2)
    ...
    //ship
    createPlatform(windowWidth/2 - 600,windowHeight-100, 0.5)
    door = createSprite(windowWidth/2 - 300,windowHeight/2)
    door.addImage(doorImg)
    door.scale = 0.8
    door.setCollider("rectangle", 50,0,200,1000)
    createPlatform(windowWidth/2,windowHeight-100, 0.5)
    createPlatform2(windowWidth/2 - 1500,windowHeight-100, 0.1)
    createPlatform2(windowWidth/2 - 1800,windowHeight-100, 0.1)
    createPlatform2(windowWidth/2 - 2100,windowHeight-100, 0.1)
    createPlatform(windowWidth/2 - 1300,windowHeight-100, 0.5)
    createPlatform(windowWidth/2 - 2500,windowHeight-100, 0.5)
    createPlatform2(windowWidth/2 -2700,windowHeight/2-100, 0.1)
    createPlatform2(windowWidth/2 -3200,windowHeight/2, 0.1)
    createPlatform2(windowWidth/2 -3600,windowHeight/2+50, 0.1)
    createPlatform(windowWidth/2 - 4100,windowHeight-100, 0.5)
    createPlatform2(windowWidth/2 -4600,windowHeight/2, 0.2)
    createPlatform(windowWidth/2 - 5000,windowHeight-100, 0.5)
    fall = createSprite(windowWidth/2 - 5650,windowHeight-80)
    fall.addImage(PlatformI2)
    fall.scale = 0.5
    fall.setCollider("rectangle", -10 , -360 ,580,50)
    stopper = createSprite(windowWidth/2 - 5200,windowHeight/2, 20,2000)
    stopper.visible = false
    fallbox = createSprite(windowWidth/2 - 5650,windowHeight-80)
    fallbox.setCollider("rectangle", -10 , -200 ,300,20)
    fallbox.visible = false
    JG.add(fallbox)
    falldetect = createSprite(windowWidth/2 - 5650,windowHeight-80)
    falldetect.setCollider("rectangle", -10 , -300 ,300,50)
    falldetect.visible = false

    createPlatform2(windowWidth/2 -6200,windowHeight/2, 0.25)
    createPlatform2(windowWidth/2 -6650,windowHeight/2+10, 0.1)
    createPlatform2(windowWidth/2 -7000,windowHeight/2, 0.25)
    createPlatform(windowWidth/2 - 7500,windowHeight-80, 0.5)

    //UNDERGROUND
    createPlatform(windowWidth/2 - 20000,windowHeight-100, 0.5)
    //LVL1
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++enemy2+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    enemy2 = createSprite(windowWidth/2 + 3250, windowHeight/2)
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++enemy4+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++enemy5++++++++++++++++++++++++++++++++++++
 enemy5 = createSprite(windowWidth/2 -1300,  windowHeight/2+30)
 enemy5.addAnimation("saw",sawA)
 enemy5.setCollider("circle",0,0,155)
 enemy5.scale = 0.3
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++enemy6++++++++++++++++++++++++++++++++++++
  enemy6 = createSprite(windowWidth/2 -4100,  windowHeight/2+30)
  enemy6.addAnimation("saw",sawA)
  enemy6.setCollider("circle",0,0,155)
  enemy6.scale = 0.3
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++enemy7++++++++++++++++++++++++++++++++++++
  enemy7 = createSprite(windowWidth/2 -5000,  windowHeight/2+30)
...
//===============================================================wrench==============================================================================
    ...
    wrench.scale = 0.3
//===============================================================wrench2==============================================================================
    wrench2 = createSprite(windowWidth/2-7500 , windowHeight/2)
...
if(player.y > windowWidth-200 && level === 1){
 checkpoint = 3
}
